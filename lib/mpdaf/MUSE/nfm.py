...
from astropy.modeling.models import Moffat2D, Linear1D
...
from ..obj.fitting import AiryDisk2D
...
def init_mphd_model(shape, lbda, R_0=None, verbose=False, with_bounds=False,
                    peak=1):
    # initial parameters
...
def fit_mphd(img, lbda, use_var=False, maxiter=2000, with_ellipticity=False,
    ...
    model = init_mphd_model(img.shape, lbda, R_0=R_c, verbose=verbose,
                            peak=img.data.max())
