...
class TestSource():
    ...
    def test_add_narrow_band_image(self):
        ...
        nose.tools.assert_true('MUSE_[OIII]5007' in src.images)
        nose.tools.assert_true('MUSE_HALPHA6563' in src.images)
        nose.tools.assert_true('MUSE_[SII]6724' in src.images)
        nose.tools.assert_true('MUSE_HBETA4861' in src.images)
        ...
        nose.tools.assert_true('SEG_MUSE_[OIII]5007' in src.images)
        nose.tools.assert_true('SEG_MUSE_HALPHA6563' in src.images)
        ...
        src.find_union_mask(union_mask='MASK_OBJ', seg_tags=['SEG_MUSE_WHITE', 'SEG_MUSE_[OIII]5007', 'SEG_OBS7128', 'SEG_MUSE_HBETA4861', 'SEG_MUSE_HALPHA6563', 'SEG_MUSE_[SII]6724'])
        ...
        nose.tools.assert_true('MUSE_HALPHA6563_SKYSUB' in src.spectra)
        ...
        nose.tools.assert_true('MUSE_HALPHA6563' in src.spectra)
